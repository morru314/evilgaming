    ...
    <footer className="bg-black text-white py-8 border-t border-gray-800">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-400">
              Tu portal definitivo de gaming. Mantente al día con las últimas noticias, análisis detallados y guías
              exclusivas del mundo de los videojuegos.
            </p>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} EvilGaming. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  )
